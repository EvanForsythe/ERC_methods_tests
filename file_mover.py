...
parser.add_argument('-l','--list_file', type=int, metavar='', required=True, help='This should be a text file containing the name of each file to copy, with each file on a new line')
